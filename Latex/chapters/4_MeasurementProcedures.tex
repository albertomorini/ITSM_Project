...
To support the Continuous Improvement CSF~\ref{sec:continuousimprovement}, the selected metric for the Service Costs is ``\textbf{Total IT Service Cost per Service}'' (TISCS). This metric measures the total financial cost associated with delivering, operating, supporting and maintaining an individual IT service over a defined reporting period. \\
