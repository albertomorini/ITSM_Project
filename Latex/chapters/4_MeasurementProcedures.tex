...
For this KPI~\gls{kpi} the process affected are:
\begin{itemize}
...
Overall, this KPI~\gls{kpi} supports the Process Factory critical success factor by ensuring that IT services are not only delivered efficiently but are also structurally consistent, enabling economies of scale, improved governance, and reduced complexity across the bank`s global IT operations. \\
...
In the formulation of this KPI~\gls{kpi} metric, Direct Service Costs and Allocated Indirect Cost elements can be listed as following:
