...
%   Still have to fix some stuff here
...
% KPI 1 — Backlog Aging ----> conflict in waste?
...
% Field	Value
% Description	Average number of days that unresolved tickets remain in the backlog.
% Unit	Days
% Formula	Sum of age of all open tickets ÷ Number of open tickets
% Frequency	Daily measurement, Weekly report
----------------

% KPI 4 — Backlog Clearance Rate

% Metric

% Percentage of backlog resolved during the reporting period.
...
% Field	Value
% Description	Measures the team's effectiveness in reducing outstanding work.
% Unit	%
% Formula	(Tickets closed during period ÷ Tickets in backlog at start of period) × 100
% Frequency	Weekly

% ------------

% Priority Backlog Distribution

% Metric

% Percentage of backlog by priority level.
...
% Field	Value
% Description	Tracks backlog distribution across priority levels to ensure high-priority work receives immediate attention.
% Unit	%
% Formula	(Tickets of each priority ÷ Total backlog) × 100
% Frequency	Daily