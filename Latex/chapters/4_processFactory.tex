...
% To measure the level of standardization achieved within the IT organization, the ``\textbf{percentage of standardized services}'' works as KPI, explained in next chapter~\ref{sub:stdCompliaceRate}. --> EXPLAINED JUST AFTER
...
Several IT Service Management processes have a direct impact on Standardization Compliance Rate achieved within the organization:
