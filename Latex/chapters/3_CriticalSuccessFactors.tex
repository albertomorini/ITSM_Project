...
Overral, the objective is to balance operational efficiency with service performance and customer expectations; where the ``\textbf{IT Service costs distributions}''~\ref{sub:itservicecost} works as KPI.
