...
\begin{itemize}
    ...
    This initiative must be done by collecting and analyzing performance data generated through KPIs~\gls{kpis}; then the corporation can identify opportunities for improvement and monitor potential risks.
