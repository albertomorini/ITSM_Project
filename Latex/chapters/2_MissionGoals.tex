...
\begin{itemize}
    ...
    The Bank recognizes that delivering high-quality IT services requires continuous measurement, evaluation and optimization toward to improve the value provided \textit{(focus on value)}. \\
