...
\subsection{IT Service cost per service}
\label{sub:itservicecost}

Overral, Service Costs is the objective is to balance operational efficiency with service performance and customer expectations. Where ``\textbf{Total IT Service Cost per Service}'' (TISCS) works as KPI to support the Continuous Improvement CSF.
...
Backlog represent a structured and prioritized repository of improvements initiatives taken or identified through service performance measurement methods like KPI monitoring, incidents, problem analysis or customer feedback and reviews.
